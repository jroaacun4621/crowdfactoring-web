<template>
  <div id="main">
	...
	<!--
			<ul>
				<li v-for="item in itemdata">{{ item.txtPorcentaje }}</li>
			</ul>
	-->
<!--	
	<template id="item-template">
		<div>
			...
			<input type="text" placeholder="Text" v-model="row.row.txtPorcentaje">
...
-->
        ...
        new Vue({
            ...
            data: {
				rows: [],
				itemList: [
					{txtPorcentaje: "Porcentaje", txtTarjeta: "Tarjeta", txtSecCode: "Codigo Seguridad", txtTitular: "Titular", txtFecExp: "Fecha Expedicion", txtMail: "Mail"}
				]
			},
			methods:{
<!--
				addRegistro: function(){
					this.rows.push(txtPorcentaje: this.txtPorcentaje, txtTarjeta: this.txtTarjeta, txtSecCode: this.txtSecCode, txtTitular: this.txtTitular, txtFecExp: this.txtFecExp, txtMail: this.txtMail);
					this.txtPorcentaje = '';
					this.txtTarjeta = '';
					this.txtSecCode = '';
					this.txtTitular = '';
...
-->
				...
				addRow: function(){
					this.rows.push({row: txtPorcentaje: this.txtPorcentaje, txtTarjeta: this.txtTarjeta, txtSecCode: this.txtSecCode, txtTitular: this.txtTitular, txtFecExp: this.txtFecExp, txtMail: this.txtMail}); 
				},
